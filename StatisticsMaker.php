...
class StatisticsMaker
{
    public static function metadataStatistics() {
        ...
        $query = "select baseUrl, aq_md_searchstring, aq_md_description from webpage where baseUrl is not null or baseUrl not like '' and aq_md_description is null or aq_md_description like ''".
